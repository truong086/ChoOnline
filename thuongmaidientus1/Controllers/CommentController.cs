...
namespace thuongmaidientus1.Controllers
{
    ...
    public class CommentController : ControllerBase
    {
        ...
        public async Task<PayLoad<CommentDTO>> CreateComment([FromBody]CommentDTO commentDTO)
        {
        ...
        public async Task<PayLoad<object>> FindAll(int id, int page, int pageSize)
        {
            return await commentService.FindAll(id, page, pageSize);
        }

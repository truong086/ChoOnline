...
namespace thuongmaidientus1.Models
{
    public class DBContexts : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("User Id=sa;Password=1234;Server=LAPTOP-D5OKMO3H\\SQLEXPRESS;Database=thuongmaidientus1;Trusted_Connection=True; TrustServerCertificate=true; Encrypt=false;")
